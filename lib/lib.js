...
function openDialog(title, description, placeHolder, leftPlaceHolder, leftNGClick, leftEvent, rightPlaceHolder, rightNGClick, rightEvent)
{
    var dialog_upload = document.getElementById('Dialog_Upload');
    var dialog = document.getElementById('Dialog');
    var cssClass = "open";
    if(containsClass(dialog_upload, cssClass))
        ...
        if(leftPlaceHolder != null || leftNGClick != null || leftEvent != null)
        {
            var leftButton = document.createElement("div");
            leftButton.setAttribute('ng-controller', 'FileCtrl');
            leftButton.setAttribute('ng-click', leftNGClick);
            leftButton.setAttribute('class', 'button label-blue left');
            if(leftEvent) leftButton.addEventListener("click", leftEvent);
        ...
        if(rightPlaceHolder != null || rightNGClick != null || rightEvent != null)
        {
            var rightButton = document.createElement("div");
            rightButton.setAttribute('ng-controller', 'FileCtrl');
            rightButton.setAttribute('ng-click', rightNGClick);
            rightButton.setAttribute('class', 'button right');
            if(rightEvent) rightButton.addEventListener("click", rightEvent);
